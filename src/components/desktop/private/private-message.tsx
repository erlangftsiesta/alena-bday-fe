...
import { Heart, Play, Pause, Music, X, Sparkles, Lock, Globe, Star } from "lucide-react"
import { usePrivateMessages } from "../../../hooks/usePrivateMessage"

export default function PrivateMessagesDesktop() {
  const {
    messages,
    loading,
    error,
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-100 via-orange-50 to-pink-200 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-pink-600 font-medium text-xl">Loading private messages... 🔒</p>
        </div>
      </div>
    )
  }
      ...
      <div className="p-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-pink-600 text-xl font-medium">Your secret musical treasures 🔒💕</p>
          ...
          {messages.length === 0 && !loading && (
            <div className="text-center py-20">
              <Lock className="w-24 h-24 text-pink-300 mx-auto mb-6" />
              <p className="text-pink-600 text-2xl font-medium mb-2">No private messages yet</p>
              <p className="text-pink-500 text-lg">Your secret messages will appear here 🔒</p>
            </div>
          )}
        </div>
      </div>
          ...
          <div className="bg-white rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-hidden animate-modal-appear shadow-2xl">
            ...
            <div className="p-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-pink-800 font-bold text-xl mb-4">Private Message:</h3>
                ...
                <div className="pt-4">
                  <button
                    ...
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-orange-400 to-pink-400 text-white py-4 rounded-2xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 flex items-center justify-center gap-3"
                  >
